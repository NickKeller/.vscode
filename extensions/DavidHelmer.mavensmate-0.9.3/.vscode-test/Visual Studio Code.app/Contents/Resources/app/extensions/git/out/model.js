    ...
    run(operation, runOperation = () => Promise.resolve(null)) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return shouldShowProgress(operation)
                ? vscode_1.window.withScmProgress(run)
                : run();
        });
    }
...
exports.Model = Model;
//# sourceMappingURL=https://ticino.blob.core.windows.net/sourcemaps/6eaebe3b9c70406d67c97779468c324a7a95db0e/extensions/git/out/model.js.map
